...
const part = (
  ...
  motionIndex = 0,
): MobVisualPartDescriptor => ({ center, color, id, motion, motionIndex, role, size })
...
const descriptors: Readonly<Record<MobVisualKind, MobVisualDescriptor>> = {
  blaze: {
    ...
    ], scale: [1, 1.15, 1], temperament: 'hostile',
  },
  chicken: {
    kind: 'chicken', parts: [
    ...
    ], scale: [0.72, 0.72, 0.72], temperament: 'passive',
  },
  ...
  creeper: {
    ...
    ], scale: [1, 1, 1], temperament: 'hostile',
  },
  enderman: biped(
    'enderman',
    'hostile',
  ...
  spider: {
    kind: 'spider', parts: [
      ...
      ...spiderLegs([38, 31, 35]),
    ], scale: [1.15, 1, 1.15], temperament: 'hostile',
  },
...
export const planMobVisual = (
  ...
  const animation = { phaseRadians, progress, state: input.state } as const
